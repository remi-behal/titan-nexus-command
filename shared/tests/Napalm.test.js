...
describe('Napalm Weapon Mechanics (Refined)', () => {
    it('should fly 150px short of target and extend fire forward', () => {
        ...
        // p1 Hub at (100, 100)
        gs.addEntity({ id: 'h1', type: 'HUB', owner: 'p1', x: 100, y: 100, hp: 5, deployed: true, isStarter: true });

        // Launch with pull distance 300 (Max Pull) -> actual distance 800 (Max Launch)
        const pull = 300;
        const expectedLaunchDist = 800; // Correct based on EntityStats/calculateLaunchDistance
        ...
        const impactState = snapshots.find(s => s.state.entities.some(e => e.type === 'NAPALM_FIRE'));
    ...
    it('should damage structures if only touching (target radius included)', () => {
        ...
        gs.entities = [
            { id: 'f1', type: 'NAPALM_FIRE', x: 200, y: 100, startX: 200, startY: 100, endX: 350, endY: 100, roundsLeft: 2, isHazard: true },
            { id: 'target1', type: 'HUB', owner: 'p2', x: 400, y: 100, hp: 5, deployed: true, isStarter: true, size: 40 },
            { id: 'target2', type: 'HUB', owner: 'p2', x: 410, y: 100, hp: 5, deployed: true, isStarter: true, size: 40 }
        ];
    ...
    it('should apply damage twice if turn has 2 rounds', () => {
        ...
        gs.entities = [
            { id: 'h_src', type: 'HUB', owner: 'p1', x: 100, y: 100, hp: 5, deployed: true, isStarter: true, fuel: 10 },
            { id: 'f1', type: 'NAPALM_FIRE', x: 200, y: 100, startX: 200, startY: 100, endX: 350, endY: 100, roundsLeft: 2, isHazard: true },
            { id: 'target1', type: 'HUB', owner: 'p2', x: 250, y: 100, hp: 5, deployed: true, isStarter: true, size: 40 }
        ];
    ...
    it('should expire at end of turn even if rounds remain', () => {
        ...
        gs.addEntity({
            id: 'f1',
            type: 'NAPALM_FIRE',
            x: 200, y: 100, startX: 200, startY: 100, endX: 350, endY: 100,
            roundsLeft: 5, isHazard: true
        });
