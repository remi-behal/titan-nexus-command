...
describe('Reclaimer Tactical Weapon', () => {
    ...
    it('should reclaim multiple friendly buildings and refund 50% cost', () => {
        ...
        const ext1 = gameState.addEntity({ type: 'EXTRACTOR', owner: P1, x: 700, y: 500, deployed: true });
        const ext2 = gameState.addEntity({ type: 'EXTRACTOR', owner: P1, x: 750, y: 500, deployed: true });
    ...
    it('should ignore enemy buildings', () => {
        ...
        const extP2 = gameState.addEntity({ type: 'EXTRACTOR', owner: P2, x: 700, y: 500, deployed: true });
    ...
    it('should trigger Link Decay for orphaned buildings', () => {
        const hub = gameState.entities.find(e => e.owner === P1 && e.isStarter);
        const bridge = gameState.addEntity({ type: 'HUB', owner: P1, x: 700, y: 500, deployed: true });
        const ext = gameState.addEntity({ type: 'EXTRACTOR', owner: P1, x: 750, y: 500, deployed: true });
