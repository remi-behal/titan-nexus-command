# Task List: Titan: Nexus Command

## Phase 1: Single-Player Prototype (Weeks 1-2)
- [x] Initialize project (React + Vite) <!-- id: 7 -->
- [x] **Design Game Core**: Define the "Board" and "Player" state objects <!-- id: 18 -->
- [x] Implement Basic Rendering (Canvas or DOM) <!-- id: 19 -->
- [x] Implement Local Game Loop (Input -> State Update -> Render) <!-- id: 20 -->
- [x] Verify: Play a full "turn" locally against a dummy/mock opponent <!-- id: 21 -->
...
- [ ] Verify: Open 2 tabs, actions in one reflect in the other <!-- id: 23 -->
